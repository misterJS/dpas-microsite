...
export const productDetails: Record<string, ProductDetail> = {
  ACC: {
    ...
    desc: "Perlindungan yang mengutamakan Manfaat Meninggal Dunia Akibat Kecelakaan, dengan Santunan Asuransi atas risiko meninggal dunia yang diakibatkan oleh Kecelakaan hingga Rp54.000.000",
    terms: [
      { term_id: 101, term: 6, term_unit: "M" },
      { term_id: 102, term: 12, term_unit: "M" },
    ],
    packages: [
      {
        package_id: 1101,
        ...
        package_code: "SIL",
        benefits: [
          { benef_code: "DEATH_ACC", benef_name: "Manfaat meninggal dunia akibat kecelakaan", benef_amount: 18000000, benef_type: "LIMIT" },
        ],
      },
      {
        package_id: 1102,
        ...
        package_code: "GLD",
        benefits: [
          { benef_code: "DEATH_ACC", benef_name: "Manfaat meninggal dunia akibat kecelakaan", benef_amount: 36000000, benef_type: "LIMIT" },
        ],
      },
      {
        package_id: 1103,
        ...
        package_code: "PLT",
        benefits: [
          { benef_code: "DEATH_ACC", benef_name: "Manfaat meninggal dunia akibat kecelakaan", benef_amount: 54000000, benef_type: "LIMIT" },
        ],
      },
    ],
  },
  CTAK: {
    ...
    terms: [
      { term_id: 103, term: 6, term_unit: "M" },
      { term_id: 104, term: 12, term_unit: "M" },
    ],
    packages: [
      {
        package_id: 1201,
        ...
        package_code: "SIL",
        benefits: [
          { benef_code: "TOTAL_DISABILITY_ACC", benef_name: "Manfaat cacat total akibat kecelakaan", benef_amount: 6000000, benef_type: "LIMIT" },
        ],
      },
      {
        package_id: 1202,
        ...
        package_code: "GLD",
        benefits: [
          { benef_code: "TOTAL_DISABILITY_ACC", benef_name: "Manfaat cacat total akibat kecelakaan", benef_amount: 12000000, benef_type: "LIMIT" },
        ],
      },
      {
        package_id: 1203,
        ...
        package_code: "PLT",
        benefits: [
          { benef_code: "TOTAL_DISABILITY_ACC", benef_name: "Manfaat cacat total akibat kecelakaan", benef_amount: 24000000, benef_type: "LIMIT" },
        ],
      },
    ],
  },
...
export const checkAvailability: CheckAvailabilityRes = {
  ...
  decisions: "Y",
  decisionDescription: "Client has no existing digital product PLS.",
  validations: {
    MaxAllowedPoliciesPerLifeAssuredCheck: "1",
    MaxAllowedPoliciesPerEmailIdentifier: "1"
  }
}

export const payment: PaymentRes = {
